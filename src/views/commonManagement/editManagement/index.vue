  ...
  <div class="userManagement-container">
    ...
    <el-table v-loading="listLoading" :data="list" :element-loading-text="elementLoadingText" @selection-change="setSelectRows">
      ...
      <el-table-column
        ...
        :key="index"
        :label="column.text != '' ? column.text : column.field"
        :prop="column.field"
...
<script>
  import { doDelete, getList, field } from '@/api/editManagement'
  import Edit from './components/editManagementEdit'
